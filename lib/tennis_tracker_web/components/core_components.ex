defmodule TennisTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: TennisTrackerWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TennisTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TennisTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
