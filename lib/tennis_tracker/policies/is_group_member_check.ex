defmodule TennisTracker.Policies.IsGroupMemberCheck do
  @moduledoc """
  SimpleCheck for create actions. Verifies the actor is a member of the group
  ...
  def describe(_opts), do: "actor is a member of the changeset's group"
