defmodule TennisTracker.DataCase do
  @moduledoc """
  ...
  by setting `use TennisTracker.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(TennisTracker.Repo, shared: not tags[:async])
